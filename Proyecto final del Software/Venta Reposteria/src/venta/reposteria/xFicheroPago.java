...
public class xFicheroPago {
    ...
    private JTextField identificacionEspecial;
    private JTextField nombreProducto;
    private JTextField tamaño;
    private JTextField precio;
    private JTextField descuentoAplicado1;
    ...
    public xFicheroPago(JTextField nombreCliente , JTextField identificacionEspecial , JTextField nombreProducto, JTextField tamaño, JTextField precio, JTextField descuentoAplicado1,JTextField importe, JTextField cambio , JTextField totalPagar)
    {
        this.nombreCliente = nombreCliente;
        this.identificacionEspecial = identificacionEspecial;
        this.nombreProducto = nombreProducto;
        this.tamaño= tamaño;
        this.precio=precio;
        this.descuentoAplicado1=descuentoAplicado1;
    ...
    public void Siguiente()
    {
        ...
        while (It.hasNext())
        {
            ...
            {   //separa el registro por campos. Separador = ","
                ...
                this.identificacionEspecial.setText(datos[1]);
                this.nombreProducto.setText(datos[2]);
                break;
            }
            count ++;
        }
