...
public class xFichero {
    ...
    //controles swing
    private JTextField identificacionPersonal;
    ...
    public xFichero(JTextField identificacionPersonal , JTextField nombre, JTextField direccion,JTextField exterior,JTextField colonia,JTextField ciudad,JTextField codigoPostal, JTextField telefonoFijo, JTextField telefonoMovil, JTextField correo , JTextField interior, JTextArea observacion)
    {
    ...
    public void Siguiente()
    {
        ...
        while (It.hasNext())
        {
            ...
            {   //separa el registro por campos. Separador = ","
                ...
                this.identificacionPersonal.setText(datos[0]);
                this.nombre.setText(datos[1]);
                this.direccion.setText(datos[2]);
                this.exterior.setText(datos[1]);
