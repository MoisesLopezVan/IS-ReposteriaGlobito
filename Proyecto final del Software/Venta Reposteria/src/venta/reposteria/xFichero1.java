...
public class xFichero1 {
    ...
    private JTextArea especial;
    

    //Constructor de clase
    public xFichero1(){}

    public xFichero1(JTextField identificacion , JTextField fecha , JTextArea especial )
    {
    ...
    public void Siguiente()
    {
        ...
        while (It.hasNext())
        {
            ...
            {   //separa el registro por campos. Separador = ","
                ...
                this.identificacion.setText(datos[0]);
                this.fecha.setText(datos[1]);
                this.especial.setText(datos[2]);
                break;
            }
            count ++;
        }
